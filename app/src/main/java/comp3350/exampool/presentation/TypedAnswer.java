...
public class TypedAnswer extends AppCompatActivity {
    ...
    */
    ...
    public void homeButttonOnClick(View v){
        Intent goBack = new Intent(TypedAnswer.this, HomeActivity.class);
        TypedAnswer.this.startActivity(goBack);
    }

    public void userButttonOnClick(View v){
        Toast.makeText(TypedAnswer.this, "You clicked user",Toast.LENGTH_SHORT).show();
    }

    public void backButttonOnClick(View v){
        Intent goBack = new Intent(TypedAnswer.this, FlashcardsCreatePromptActivity.class);
        TypedAnswer.this.startActivity(goBack);
    }

    public void nextButtonOnCLick(View view) {
        Intent goBack2 = new Intent(TypedAnswer.this, TrueFalseActivity.class);
        TypedAnswer.this.startActivity(goBack2);
    }
}
